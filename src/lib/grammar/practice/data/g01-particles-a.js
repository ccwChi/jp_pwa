export default [
  {
    id: 'practice-particles-a',
    level: 'N5',
    title: '助詞（は・が・を・に・で・と・も・の）',
    intro: '田中さんの自己紹介と一日の生活。',
    grammarIds: [
      'wa-topic', 'ga-subject', 'wo-object', 'ni-time-target',
      'de-location-method', 'to-and-with', 'mo-also', 'no-possessive-nominalizer',
    ],
    sentences: [
      {
        grammarId: 'wa-topic',
        ...
        cloze: { options: ['は', 'を', 'に', 'で'], answerIndex: 0 },
      },
      {
        grammarId: 'ga-subject',
        ...
        cloze: { options: ['が', 'を', 'の', 'と'], answerIndex: 0 },
      },
      {
        grammarId: 'wo-object',
        ...
        cloze: { options: ['を', 'が', 'は', 'も'], answerIndex: 0 },
      },
      {
        grammarId: 'ni-time-target',
        ...
        cloze: { options: ['に', 'で', 'を', 'は'], answerIndex: 0 },
      },
      {
        grammarId: 'de-location-method',
        ...
        cloze: { options: ['で', 'に', 'を', 'へ'], answerIndex: 0 },
      },
      {
        grammarId: 'to-and-with',
        ...
        cloze: { options: ['と', 'や', 'に', 'で'], answerIndex: 0 },
      },
      {
        grammarId: 'mo-also',
        ...
        cloze: { options: ['も', 'は', 'を', 'が'], answerIndex: 0 },
      },
      {
        grammarId: 'no-possessive-nominalizer',
        ...
        cloze: { options: ['の', 'が', 'を', 'に'], answerIndex: 0 },
      },
    ],
  },
];
