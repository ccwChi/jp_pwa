export default [
  {
    id: 'practice-particles-b',
    level: 'N5',
    title: '助詞（や・へ・から・まで・か・ね・よ）',
    intro: '日本旅行の計画について話しています。',
    grammarIds: ['ya-partial-and', 'e-direction', 'kara-from', 'made-until', 'ka-question', 'ne-confirmation', 'yo-emphasis'],
    sentences: [
      {
        grammarId: 'ya-partial-and',
        ...
        cloze: { options: ['や', 'と', 'に', 'の'], answerIndex: 0 },
      },
      {
        grammarId: 'e-direction',
        ...
        cloze: { options: ['へ', 'で', 'を', 'と'], answerIndex: 0 },
      },
      {
        grammarId: 'kara-from',
        ...
        cloze: { options: ['から', 'まで', 'に', 'で'], answerIndex: 0 },
      },
      {
        grammarId: 'made-until',
        ...
        cloze: { options: ['まで', 'から', 'に', 'と'], answerIndex: 0 },
      },
      {
        grammarId: 'ka-question',
        ...
        cloze: { options: ['か', 'ね', 'よ', 'の'], answerIndex: 0 },
      },
      {
        grammarId: 'ne-confirmation',
        jp: '楽[たの]しみですね。',
        zh: '好期待呢。',
        target: 'ね',
        meaning: {
        ...
        cloze: { options: ['ね', 'よ', 'か', 'を'], answerIndex: 0 },
      },
      {
        grammarId: 'yo-emphasis',
        jp: 'このホテルはきれいですよ。',
        zh: '這間飯店很乾淨喔。',
        target: 'よ',
        meaning: {
        ...
        cloze: { options: ['よ', 'ね', 'か', 'も'], answerIndex: 0 },
      },
    ],
  },
];
