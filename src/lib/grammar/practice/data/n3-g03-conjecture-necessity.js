export default [
  {
    id: 'practice-n3-conjecture-necessity',
    level: 'N3',
    title: '推量・必要性表現（わけだ・わけではない・わけにはいかない・べきだ・に違いない）',
    titleZh: '推量與必要性表現',
    intro: '日本語が上手な友達と、約束についての会話。',
    grammarIds: ['wake-da', 'wake-de-wa-nai', 'wake-ni-wa-ikanai', 'beki-da', 'ni-chigai-nai'],
    sentences: [
      {
        grammarId: 'wake-da',
        ...
        cloze: { options: ['上手[じょうず]なわけです', '上手[じょうず]なわけではないです', '上手[じょうず]なはずがないです', '上手[じょうず]に違[ちが]いないです'], answerIndex: 0 },
      },
      {
        grammarId: 'wake-de-wa-nai',
        ...
        cloze: { options: ['嫌[きら]いなわけではないです', '嫌[きら]いなわけです', '嫌[きら]いなはずです', '嫌[きら]いに違[ちが]いないです'], answerIndex: 0 },
      },
      {
        grammarId: 'wake-ni-wa-ikanai',
        ...
        cloze: { options: ['行[い]かないわけにはいきません', '行[い]くわけではないです', '行[い]くべきです', '行[い]くに違[ちが]いないです'], answerIndex: 0 },
      },
      {
        grammarId: 'beki-da',
        ...
        cloze: { options: ['守[まも]るべきです', '守[まも]るわけです', '守[まも]るわけにはいきません', '守[まも]るに違[ちが]いないです'], answerIndex: 0 },
      },
      {
        grammarId: 'ni-chigai-nai',
        ...
        cloze: { options: ['日本人[にほんじん]に違[ちが]いありません', '日本人[にほんじん]なわけです', '日本人[にほんじん]なわけではないです', '日本人[にほんじん]であるべきです'], answerIndex: 0 },
      },
    ],
  },
];
