export default [
  {
    id: 'practice-n2-result-viewpoint',
    level: 'N2',
    title: '結果・経過表現＋評価・観点表現の応用（末に・あげく・たところで・ものだ・からして・からすると・に沿って・を問わず）',
    titleZh: '結果經過與評價觀點表現進階',
    intro: '長い議論の結果と、判断の根拠についての話。',
    grammarIds: ['sue-ni', 'ageku', 'ta-tokorode', 'mono-da', 'karashite', 'kara-suruto', 'ni-sotte', 'wo-towazu'],
    sentences: [
      {
        grammarId: 'sue-ni',
        ...
        cloze: { options: ['末[すえ]に', 'あげく', 'たところで', 'ものだ'], answerIndex: 0 },
      },
      {
        grammarId: 'ageku',
        ...
        cloze: { options: ['あげく', '末[すえ]に', 'たところで', 'ものだ'], answerIndex: 0 },
      },
      {
        grammarId: 'ta-tokorode',
        ...
        cloze: { options: ['急[いそ]いだところで', '急[いそ]いだ末[すえ]に', '急[いそ]いだあげく', '急[いそ]ぐものだ'], answerIndex: 0 },
      },
      {
        grammarId: 'mono-da',
        ...
        cloze: { options: ['泳[およ]いだものです', '泳[およ]いだ末[すえ]です', '泳[およ]いだあげくです', '泳[およ]いだところでです'], answerIndex: 0 },
      },
      {
        grammarId: 'karashite',
        ...
        cloze: { options: ['からして', 'からすると', 'に沿[そ]って', 'を問[と]わず'], answerIndex: 0 },
      },
      {
        grammarId: 'kara-suruto',
        ...
        cloze: { options: ['からすると', 'からして', 'に沿[そ]って', 'を問[と]わず'], answerIndex: 0 },
      },
      {
        grammarId: 'ni-sotte',
        ...
        cloze: { options: ['に沿[そ]って', 'からすると', 'からして', 'を問[と]わず'], answerIndex: 0 },
      },
      {
        grammarId: 'wo-towazu',
        ...
        cloze: { options: ['を問[と]わず', 'に沿[そ]って', 'からすると', 'からして'], answerIndex: 0 },
      },
    ],
  },
];
