export default [
  {
    id: 'practice-quantity-misc',
    level: 'N5',
    title: '數量與其他（助数詞・くらい・すぎる・疑問詞＋か）',
    intro: '本屋と薬局での買い物。',
    grammarIds: ['counters', 'kurai-gurai', 'sugiru', 'question-word-ka'],
    sentences: [
      {
        grammarId: 'counters',
        ...
        cloze: { options: ['三冊[さんさつ]', '三枚[さんまい]', '三本[さんぼん]', '三匹[さんびき]'], answerIndex: 0 },
      },
      {
        ...
        cloze: { options: ['くらい', 'だけ', 'しか', 'すぎ'], answerIndex: 0 },
      },
      {
        grammarId: 'sugiru',
        ...
        cloze: { options: ['すぎました', 'くらいでした', 'だけでした', 'ながらでした'], answerIndex: 0 },
      },
      {
        grammarId: 'question-word-ka',
        jp: '何[なに]か飲[の]みますか。',
        zh: '要喝點什麼嗎？',
        target: '何[なに]か',
        meaning: {
        ...
        cloze: { options: ['何[なに]か', '何[なに]が', '何[なに]を', '何[なに]は'], answerIndex: 0 },
      },
    ],
  },
];
