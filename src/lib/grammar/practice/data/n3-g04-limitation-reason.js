export default [
  {
    id: 'practice-n3-limitation-reason',
    level: 'N3',
    title: '限定・程度表現＋理由・程度表現（だけでなく・どころか・さえ・に限らず・せいで・おかげで・ことから・あまり）',
    intro: '語学力の自慢話と、遅刻・合格の理由。',
    grammarIds: ['dake-de-naku', 'dokoro-ka', 'sae', 'ni-kagirazu', 'sei-de', 'okage-de', 'koto-kara', 'amari-ni'],
    sentences: [
      {
        grammarId: 'dake-de-naku',
        ...
        cloze: { options: ['だけでなく', 'どころか', 'さえ', 'に限[かぎ]らず'], answerIndex: 0 },
      },
      {
        grammarId: 'dokoro-ka',
        ...
        cloze: { options: ['どころか', 'だけでなく', 'さえ', 'に限[かぎ]らず'], answerIndex: 0 },
      },
      {
        grammarId: 'sae',
        ...
        cloze: { options: ['さえ', 'だけ', 'しか', 'ばかり'], answerIndex: 0 },
      },
      {
        grammarId: 'ni-kagirazu',
        ...
        cloze: { options: ['に限[かぎ]らず', 'だけでなく', 'どころか', 'さえ'], answerIndex: 0 },
      },
      {
        grammarId: 'sei-de',
        ...
        cloze: { options: ['せいで', 'おかげで', 'ことから', 'あまり'], answerIndex: 0 },
      },
      {
        grammarId: 'okage-de',
        ...
        cloze: { options: ['おかげで', 'せいで', 'ことから', 'あまり'], answerIndex: 0 },
      },
      {
        grammarId: 'koto-kara',
        ...
        cloze: { options: ['ことから', 'せいで', 'おかげで', 'あまり'], answerIndex: 0 },
      },
      {
        grammarId: 'amari-ni',
        ...
        cloze: { options: ['あまり', 'せいで', 'おかげで', 'ことから'], answerIndex: 0 },
      },
    ],
  },
];
