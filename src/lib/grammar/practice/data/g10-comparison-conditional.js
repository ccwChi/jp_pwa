export default [
  {
    id: 'practice-comparison-conditional',
    level: 'N5',
    title: '比較・存在＋條件（より・一番・あります／います・と・たら・ば・なら）',
    intro: '季節の好みと京都旅行のアドバイス。',
    grammarIds: [
      'yori-hoga', 'ichiban', 'arimasu-imasu', 'position-words',
      'to-conditional', 'tara-conditional', 'ba-conditional', 'nara-conditional',
    ],
    sentences: [
      {
        grammarId: 'yori-hoga',
        ...
        cloze: { options: ['のほうが', 'が一番', 'があります', 'なら'], answerIndex: 0 },
      },
      {
        grammarId: 'ichiban',
        ...
        cloze: { options: ['一番[いちばん]', 'のほうが', 'だけ', 'しか'], answerIndex: 0 },
      },
      {
        grammarId: 'arimasu-imasu',
        ...
        cloze: { options: ['います', 'あります', 'です', 'ました'], answerIndex: 0 },
      },
      {
        grammarId: 'position-words',
        ...
        cloze: { options: ['の隣[となり]', 'の中[なか]', 'の上[うえ]', 'の前[まえ]'], answerIndex: 0 },
      },
      {
        grammarId: 'to-conditional',
        ...
        cloze: { options: ['と', 'たら', 'ば', 'なら'], answerIndex: 0 },
      },
      {
        grammarId: 'tara-conditional',
        ...
        cloze: { options: ['たら', 'と', 'ば', 'なら'], answerIndex: 0 },
      },
      {
        grammarId: 'ba-conditional',
        ...
        cloze: { options: ['あれば', 'あったら', 'あると', 'あるなら'], answerIndex: 0 },
      },
      {
        grammarId: 'nara-conditional',
        ...
        cloze: { options: ['なら', 'と', 'たら', 'ば'], answerIndex: 0 },
      },
    ],
  },
];
