export default [
  {
    id: 'practice-n4-time-state',
    level: 'N4',
    title: '時間・状態表現（ところ・たばかり・まま・とおりに）',
    intro: '外出の準備と来日したばかりの生活。',
    grammarIds: ['tokoro', 'ta-bakari', 'mama', 'toori-ni'],
    sentences: [
      {
        grammarId: 'tokoro',
        ...
        cloze: { options: ['出[で]かけるところです', '出[で]かけているところです', '出[で]かけたところです', '出[で]かけておくところです'], answerIndex: 0 },
      },
      {
        grammarId: 'ta-bakari',
        ...
        cloze: { options: ['来[き]たばかりです', '来[く]るところです', '来[き]ているところです', '来[こ]ようとします'], answerIndex: 0 },
      },
      {
        grammarId: 'mama',
        ...
        cloze: { options: ['つけたまま', 'つけるところで', 'つけたばかりで', 'つけながら'], answerIndex: 0 },
      },
      {
        grammarId: 'toori-ni',
        ...
        cloze: { options: ['とおりに', 'ために', 'ように', 'まま'], answerIndex: 0 },
      },
    ],
  },
];
