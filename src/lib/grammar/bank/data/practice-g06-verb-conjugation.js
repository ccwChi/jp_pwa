// Extracted from practice/data/g06-verb-conjugation.js's inline sentences field — one
...
const items = [
  {
    ...
    cloze: {
      options: ['飲[の]みます', '飲[の]む', '飲[の]んで', '飲[の]まない'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['見[み]る', '見[み]ます', '見[み]て', '見[み]た'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['開[あ]けて', '開[あ]ける', '開[あ]けた', '開[あ]けない'],
      answerIndex: 0,
    },
  },
  {
  ...
  },
  {
    ...
    cloze: {
      options: ['行[い]かない', '行[い]く', '行[い]った', '行[い]って'],
      answerIndex: 0,
    },
  },
];
