// Extracted from practice/data/n4-g02-conjecture.js's inline sentences field — one
...
const items = [
  {
    ...
    cloze: {
      options: ['降[ふ]りそうです', '降[ふ]るそうです', '降[ふ]るようです', '降[ふ]るらしいです'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['だそうです', 'そうです', 'らしいです', 'のようです'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['いるようです', 'いそうです', 'いるらしいです', 'いたいです'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['寒[さむ]いみたいです', '寒[さむ]いようです', '寒[さむ]そうです', '寒[さむ]いらしいです'],
      answerIndex: 0,
    },
  },
  {
    ...
    cloze: {
      options: ['来[く]るらしいです', '来[き]そうです', '来[く]るようです', '来[く]るみたいです'],
      answerIndex: 0,
    },
  },
];
